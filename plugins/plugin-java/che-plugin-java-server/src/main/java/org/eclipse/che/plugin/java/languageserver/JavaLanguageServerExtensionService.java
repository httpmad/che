...
import org.eclipse.che.jdt.ls.extension.api.dto.ResourceToMove;
...
public class JavaLanguageServerExtensionService {
  ...
  private CheWorkspaceEdit move(MoveSettings moveSettings) {
    ...
    List<ResourceToMove> resourceToMove =
        moveSettings
            .getElements()
            .stream()
  ...
  private RefactoringStatus verifyMoveDestination(MoveSettings moveSettings) {
    ...
    return doGetOne(Commands.VERIFY_MOVE_DESTINATION, singletonList(moveSettings), type);
  }
